        ...
        <div className=\"mx-auto max-w-7xl px-4 sm:px-6 lg:px-8\">
          <div className=\"lg:flex items-end justify-between gap-10\">
            <div>
              ...
              <p className=\"mt-3 text-neutral-700 max-w-2xl\">We make donation pickups fast and flexible. Join our monthly pickup route or schedule a one‑time clean‑out. We’ll feature your store on our site and socials.</p>
            </div>
      ...
      <section id=\"join\" className=\"py-16 lg:py-24\">
        <div className=\"mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-start\">
          <div>
            ...
            <p className=\"mt-3 text-neutral-700 max-w-prose\">Students, store owners, and supporters are welcome. Volunteer for pickups, sewing & repairs, social media, or event ops. Every hour helps keep clothes in use and out of landfills.</p>
